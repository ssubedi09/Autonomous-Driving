...
class TestMPPIController(unittest.TestCase):
    ...
    def test_sample_controls(self):
        ...
        params["K"] = 10
        params["T"] = 4
        controller = ModelPredictivePathIntegral(**params)
        ...
        gt_controls = np.array([[ 3.32896626,  1.78819744, -3.86350073, -0.02095962],
       [ 1.55333993, -1.8002139 ,  0.66377896,  0.27137131],
       [ 0.01072858, -0.43650053,  1.08256547,  3.00759343],
       [-2.41266418,  2.57068519,  0.57157533,  1.11284403],
       [-2.84150553,  0.3378422 ,  3.7113425 , -2.69951221],
       [-4.9443207 , -4.35843074,  0.66517541,  5.96241833],
       [ 2.80922813,  4.18155553,  0.24787304,  3.49499094],
       [-0.67811997,  1.53301046, -0.66829297, -1.37327254],
       [ 0.33177074, -1.19035504,  3.2711827 ,  0.4875332 ],
       [ 1.00052497, -0.84408084,  3.14118066, -1.82992376]])
        np.testing.assert_allclose(
            controls[:,:,1],
            gt_controls,
            err_msg="The sampled control commands should be as same as gt_controls",
            rtol=1.e-5
        )
...
if __name__ == "__main__":
    rosunit.unitrun("control", "test_mppi", TestMPPIController)
